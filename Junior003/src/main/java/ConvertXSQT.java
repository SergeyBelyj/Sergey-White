...
public class ConvertXSQT {
        ...
        public void transform(String dest) throws Exception {
            String XSFILE = "C:/projects/Sergey-White/Junior003/src/main/java/xml/rules.xsl";
            String INFILE = dest;
            String OUTFILE = "C:/projects/Sergey-White/Junior003/src/main/java/xml/xslt.xml";
